# Street Water Detection Dataset 3950 images with yolo and voc annotations

# Body

Street Waterlogging Detection Dataset, 3950 images with yolo and voc annotations
Ideal for urban waterlogging detection, intelligent transportation, AI recognition, etc., with comprehensive data ready to use
available for purchase immediately upon purchase, non-refundable or exchangeable
For those in need, just click to purchase. Details can be privately messaged for
